...
describe 'List', ->
    ...
    describe '#copy({tags})', ->
        ...
        @beforeAll prepare -> temp = service.fetchList('My-Favourite-Employees').then (l) -> l.copy(args)
        @afterAll always -> if temp? then temp.then((l) -> l.del()) else success()
    ...
    describe '#copy({name, tags})', ->
        ...
        @beforeAll prepare -> cleanUp().then -> service.fetchList('My-Favourite-Employees').then (l) -> l.copy args
    ...
    describe '#copy(name)', ->
        ...
        @beforeAll prepare -> cleanUp().then -> service.fetchList('My-Favourite-Employees').then (l) -> l.copy name
        @afterAll always cleanUp
