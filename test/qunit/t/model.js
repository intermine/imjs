(function () {
  ...
  var name        = 'testmodel';
  var utils       = intermine.funcutils;
  var invoke      = utils.invoke;
  var nameIsRight = _.bind(utils.flip(equal), null, 'Name is ' + name, name);
  var employees   = [ "Employee", "Manager", "CEO"];
  var things      = [
    "Thing", "Employable", "Contractor", "Employee",
    "Manager", "CEO", "Address"
  ];
