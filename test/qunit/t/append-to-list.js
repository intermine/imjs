(function () {
  ...
  var set    = intermine.funcutils.set
  var args   = {name: 'temp-olders', tags: ['js', 'qunit', 'testing']}
  ...
  asyncTest('Can append to a list from a querVy', 3, function () {
    var self = this
    var count = this.s.count
    var query = this.s.query
